...
class ReportAgent:
    ...
    def __init__(
        ...
        tools_service: Optional[Any] = None
    ):
        """
        初始化Report Agent
        ...
        Args:
            ...
            tools_service: 工具服务（可选，支持ZEP或Obsidian）
        """
        ...
        if tools_service is not None:
            ...
            # 兼容旧代码：如果未提供工具服务，则尝试创建
            from .obsidian_tools import create_tools_service
            self.tools_service = create_tools_service()

        # 保持向后兼容：zep_tools 属性指向 tools_service
        self.zep_tools = self.tools_service
